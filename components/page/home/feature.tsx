      ...
      <div className="pb-6 my-12">
        <div className="container max-w-6xl">
          <HeaderSection
            ...
            subtitle="Astreak is providing a full-featured Cloud based SaaS solution for managing all aspects of your Institution. It is a complete solution for your Institution."
          />
