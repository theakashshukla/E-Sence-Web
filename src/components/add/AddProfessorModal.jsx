...
const AddProfessorModal = () => {
  ...
  const [departments] = useCollection(collection(firestore, "departments"));
                        ...
                        <div className="mb-4">
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              setDepartment({
                                name: selectedDepartment.doc.data().department
                                  .name,
                                code: selectedDepartment.doc.data().department
                                  .code,
                              });
                            }}
                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
